    ...
    return (
      <form style={styles.form} onSubmit={this.handleSubmit.bind(this)}>
        ...
        <div style={styles.div}>
          ...
          <textarea style={[styles.input, {height: '100%'}]} rows='20' ref='content' defaultValue={this.props.post ? this.props.post.content : ''} />
        </div>

        <div style={styles.actions}>
          <button style={styles.button}>{this.props.label}</button>
